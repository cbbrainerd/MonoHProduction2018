...
# with command line options: step3 --filein file:foo.root --fileout file:bar.root --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --runUnscheduled --conditions 102X_upgrade2018_realistic_v20 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename step3_2018.py --no_exec
